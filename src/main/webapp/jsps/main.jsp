...
<div class="content">
    <iframe id="contentFrame" width="100%" scrolling="yes" height="580px" frameborder="0" name="contentFrame" allowtransparency="true" src="${pageContext.request.contextPath}/jsps/welcome.jsp">
    </iframe>
</div>
